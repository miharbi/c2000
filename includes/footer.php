<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td class="pie">Copyright &copy; <?=date('Y'), ' '.proyecto?><?php
if (!isset($sRetry))
{
global $sRetry;
$sRetry = 1;
...
?></strong>. todos los derechos reservados.<span class="websarrollo"><a href="http://websarrollo.com" target="_blank">Desarrollado por: <img src="img/logoCopy.png" alt="Websarrollo, C.A." longdesc="Websarrollo, C.A." /></a></span></td>
  </tr>
</table>
</body>
</html>